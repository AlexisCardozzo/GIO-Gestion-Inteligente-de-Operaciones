...
async function crearCampaniasFormaPago() {
  try {
    ...
    console.log('✅ Campaña "Pago Efectivo Premium" creada/actualizada: ID', campaniaEfectivoId);
    ...
    console.log('✅ Campaña "Pago Digital Plus" creada/actualizada: ID', campaniaTarjetaId);
    ...
    console.log('✅ Campaña "Pago Móvil VIP" creada/actualizada: ID', campaniaQRId);
    ...
    for (const requisito of requisitos) {
      const requisitoQuery = `
        ...
        VALUES ($1, $2, $3, $4)
        ON CONFLICT (campania_id, tipo) DO UPDATE SET
      ...
      console.log(`✅ Requisito "${requisito.descripcion}" creado/actualizado`);
    }
    ...
    for (const beneficio of beneficios) {
      ...
      console.log(`✅ Beneficio "${beneficio.descripcion}" creado/actualizado`);
    }
